...
const QCommerceScene = () => {
  return (
    <section className="relative left-1/2 -translate-x-1/2 w-[100vw] max-w-[100vw] section-padding pb-space-6 md:pb-space-7 overflow-hidden bg-[#F8F8F8] text-[#111111]">
