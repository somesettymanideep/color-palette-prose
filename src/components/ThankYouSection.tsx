    ...
    <section className="relative section-padding bg-primary overflow-hidden">
      ...
      <div className="container-wide relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <div
            className="bg-primary-foreground py-space-7 md:py-space-10 px-space-5 md:px-space-9 flex flex-col items-center text-center rounded-3xl md:rounded-none"
            style={!isMobile ? { clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" } : undefined}
          >
            <div className="flex flex-col items-center mb-space-6 mt-space-4">
              ...
              <div className="flex items-center gap-3 mt-space-4">
            ...
            {/* Logo area */}
            <div className="flex items-center justify-center mb-space-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-space-5 inline-flex items-center gap-2 bg-[#25D366] text-white px-space-5 py-2.5 rounded-full font-heading font-600 text-sm hover:scale-105 transition-transform"
            >
